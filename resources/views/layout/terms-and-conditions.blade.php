...
<div class="container" style="background-color: var(--color4, #ffffff); color: var(--color2, #000000)">
    <div class="row">
        <div class="col-12 p-3 text-justify p-4">
            <h1>Terms and Conditions</h1>

            <h2>Welcome to Shoorela.com</h2>

            <p>These terms and conditions outline the rules and regulations for the use of Shoorela.com's Website.</p> 
            <span style="text-transform: capitalize;"> Shoorela.com</span> is located at:<br /> 
            <address>Dhaka City <br />- Dhaka , Bangladesh<br />
            </address>
            <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Shoorela.com's website if you do not accept all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By using Shoorela.com's website you consent to the use of cookies in accordance with Shoorela.com’s privacy policy.</p><p>Most of the modern day interactive web sites use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting. Some of our affiliate / advertising partners may also use cookies.</p>
            
            <h2>License</h2>
            <p>Unless otherwise stated, Shoorela.com and/or it’s licensors own the intellectual property rights for all material on Shoorela.com. All intellectual property rights are reserved. You may view and/or print pages from http://shoorela.com for your own personal use subject to restrictions set in these terms and conditions.</p>
            <p>You must not:</p>
            <ol>
                <li>Republish material from http://shoorela.com</li>
                <li>Sell, rent or sub-license material from http://shoorela.com</li>
                <li>Reproduce, duplicate or copy material from http://shoorela.com</li>
            </ol>
            <p>Redistribute content from Shoorela.com (unless content is specifically made for redistribution).</p>

            <h2>User Comments</h2>

            <ol>
                <li>This Agreement shall begin on the date hereof.</li>
                <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. Shoorela.com does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions ofShoorela.com, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Shoorela.comshall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
                <li>Shoorela.comreserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
                ...
                <li>You hereby grant to <strong>Shoorela.com</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
            </ol>
            ...
            <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="javascript:location='mailto:\u0063\u006f\u006e\u0074\u0061\u0063\u0074\u0040\u0073\u0068\u006f\u006f\u0072\u0065\u006c\u0061\u002e\u0063\u006f\u006d';void 0"><script type="text/javascript">document.write('\u0063\u006f\u006e\u0074\u0061\u0063\u0074\u0040\u0073\u0068\u006f\u006f\u0072\u0065\u006c\u0061\u002e\u0063\u006f\u006d')</script></a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
            ...
            <p>No use of Shoorela.com’s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
